...
var style_KerentananSosial_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    
    var labelText = ""; var value = feature.get("IKS");
    ...
    if (value >= 5.606916 && value <= 23.762304) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 23.762304 && value <= 51.551660) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 51.551660 && value <= 83.577014) {
            style = [ new ol.style.Style({
