var size = 0;
var placement = 'point';
function categories_KerentananBencanaBanjir_1(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case '2.1':
...
var style_KerentananBencanaBanjir_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    
    var labelText = ""; var value = feature.get("INDEKS_TOT");
    ...
    var style = categories_KerentananBencanaBanjir_1(feature, value, size, resolution, labelText,
